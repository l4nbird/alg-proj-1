...
class TestPrimeGenerator(unittest.TestCase):
    def setUp(self): 
        # Initialize the comparative lists
    ...
    # Tests to ensure the list lengths are correct
    ...
    # Ensures that the prime list generated by "test_prime_number" contains at least two prime numbers
    def test_prime_numbers(self):
        primeList = test_prime_number()
        self.assertGreaterEqual(len(primeList), 2, "ERROR: Prime List not long enough")

    # Ensures that the variables p and q are present
